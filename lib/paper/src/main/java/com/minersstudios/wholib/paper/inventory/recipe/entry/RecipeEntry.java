package com.minersstudios.wholib.paper.inventory.recipe.entry;

import com.minersstudios.wholib.paper.inventory.recipe.builder.RecipeBuilder;
import com.minersstudios.wholib.paper.inventory.recipe.builder.ShapedRecipeBuilder;
 ...
 * indicating whether the recipe should be shown in the {@code CraftsMenu}.
 * <br>
 * Factory methods :
 * <ul>
...
public interface RecipeEntry {
    ...
    /**
     * Returns whether the recipe should be shown in the {@code CraftsMenu}
     *
     * @return True if the recipe should be shown in the {@code CraftsMenu}
     */
     ...
     * isRegisteredInMenu flag.
     * <br>
     * If the recipe type is not supported in the {@code CraftsMenu}, the
    ...
    /**
     * Returns whether the recipe type is supported in the {@code CraftsMenu}
     *
     * @param recipe The Bukkit Recipe object
     * @return True if the recipe type is supported in the {@code CraftsMenu}
     */
