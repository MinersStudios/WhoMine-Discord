package com.minersstudios.wholib.paper.world.sound;
...
final class SoundImpl implements Sound {
    ...
    // TODO: Add support for custom sound keys
    private @NotNull String getParsedKey() {
        return WhoMine.singleton()
               .map(
                       module -> {
                           ...
                           return switch (this.key) {
                               ...
                               case WOOD_BREAK_SOUND_KEY -> config.getWoodSoundBreak();
                               case WOOD_HIT_SOUND_KEY   -> config.getWoodSoundHit();
                               case WOOD_STEP_SOUND_KEY  -> config.getWoodSoundStep();
                               default                   -> this.key;
                           };
                       }
               ).orElseThrow();
