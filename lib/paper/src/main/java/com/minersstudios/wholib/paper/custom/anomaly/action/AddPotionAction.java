package com.minersstudios.wholib.paper.custom.anomaly.action;

import com.minersstudios.wholib.paper.WhoMine;
import com.minersstudios.wholib.paper.custom.anomaly.AnomalyAction;
import com.minersstudios.wholib.paper.custom.anomaly.AnomalyIgnorableItems;
 ...
 * player is in the anomaly zone, and the time is up and the percentage is
 * reached, and if the player has no ignorable items.
 */
