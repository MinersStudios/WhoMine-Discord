...
import com.minersstudios.wholib.status.FailureStatus;
import com.minersstudios.wholib.status.SuccessStatus;
import org.jetbrains.annotations.NotNull;

import static com.minersstudios.wholib.status.Status.*;
