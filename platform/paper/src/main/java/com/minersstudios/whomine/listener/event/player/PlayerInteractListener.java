...
import com.minersstudios.wholib.paper.custom.block.event.CustomBlockRightClickEvent;
import com.minersstudios.wholib.paper.custom.block.params.BlockSettings;
                    ...
                    .ifPresent(
                            customDecor -> {
                                ...
                                if (!clickEvent.isCancelled()) {
                                    customDecor.getData().doClickAction(plugin, clickEvent);
                                    doneForMainHand(player);
                                }
                            }
                    );
