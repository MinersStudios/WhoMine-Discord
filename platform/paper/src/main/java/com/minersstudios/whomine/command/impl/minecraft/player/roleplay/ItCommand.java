...
import static com.minersstudios.wholib.paper.utility.MessageUtils.RolePlayActionType.IT;
...
public final class ItCommand extends PluginCommandExecutor {

    public ItCommand(final @NotNull WhoMine plugin) {
        super(
                plugin,
                CommandData.builder()
                .name("it")
