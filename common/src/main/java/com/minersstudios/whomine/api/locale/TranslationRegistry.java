...
public interface TranslationRegistry extends Translator {
    ...
    /**
     * Bootstraps the translation registry
     *
     * @param defaultLocale The default locale of the translation registry
     * @throws IllegalStateException If the translation registry is already
     *                               initialized
     */
    @ApiStatus.Internal
    static void bootstrap(final @NotNull Locale defaultLocale) throws IllegalStateException {
        if (isInitialized()) {
            throw new IllegalStateException("Translation registry is already initialized");
        }
    ...
    /**
     * Returns the translation registry instance
     *
     * @return The translation registry instance
     * @throws IllegalStateException If the translation registry is not
     *                               initialized
     */
    static @NotNull TranslationRegistry registry() throws IllegalStateException {
        if (!isInitialized()) {
            throw new IllegalStateException("Translation registry is not initialized");
        }

        return TranslationRegistryImpl.registry;
    }
    ...
    /**
     * Returns weather the translation registry is initialized
     *
     * @return Whether the translation registry is initialized
     */
    static boolean isInitialized() {
        return TranslationRegistryImpl.registry != null;
    }
}
