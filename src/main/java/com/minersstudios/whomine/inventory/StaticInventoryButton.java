...
/**
 * Functional interface for static inventory buttons. Static buttons are buttons
 * that do not change when the page index changes.
 * <br>
 * Used in {@link PagedInventory} and {@link ElementPagedInventory} to get
 * static buttons of the inventory.
 */
@FunctionalInterface
